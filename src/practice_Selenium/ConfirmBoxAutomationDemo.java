...
public class ConfirmBoxAutomationDemo {
...
//Thread.sleep(4000);
alert2.accept();  // this will accept confirm box
Thread.sleep(5000);
WebElement stringEle1 =driver.findElement(By.xpath("//div[text()='You pressed OK in confirmation popup']"));
String string1= stringEle1.getText();
if(string2.contains("Press a button!")) {
System.out.println("you switched to confirmBox");
if (string1.contains("You pressed OK in confirmation popup")) {
System.out.println(" you pressed ok in confirm box "); }
else {
